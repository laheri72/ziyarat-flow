...
export default function Admin() {
  ...
  // ⚡ Bolt: Memoized expensive data transformations (filtering and sorting) to prevent re-computation on every render.
  // ⚡ Bolt: Hoisted searchQuery.toLowerCase() outside the filter loop to avoid redundant string operations.
