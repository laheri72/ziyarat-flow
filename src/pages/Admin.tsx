...
export default function Admin() {
  ...
  // ⚡ Bolt: Memoize filtered and sorted progress data to avoid expensive list operations on every render
  // ⚡ Bolt: Hoist searchQuery.toLowerCase() to avoid redundant string operations in filter loop
