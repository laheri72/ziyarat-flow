...
export default function Admin() {
  ...
  // ⚡ Bolt: Hoisted searchQuery and memoized filteredProgress to prevent unnecessary filtering/sorting on every render
  const filteredProgress = useMemo(() => {
    const query = searchQuery ? searchQuery.toLowerCase() : "";
    return [...studentProgress] // shallow copy to prevent mutating original state array
      .filter((s) => {
