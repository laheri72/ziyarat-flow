...
export default function Admin() {
  ...
  // ⚡ Bolt: Memoize filtered progress to prevent re-filtering/sorting on unrelated state changes
      ...
      .sort((a, b) => {
        ...
        switch (sortBy) {
          ...
          case "completed":
            ...
            break;
          case "progress":
            aValue = a.assigned > 0 ? a.completed / a.assigned : 0;
            bValue = b.assigned > 0 ? b.completed / b.assigned : 0;
            break;
          default:
            aValue = 0;
            bValue = 0;
