...
export default function Dashboard() {
  ...
  // ⚡ Bolt: Memoize filtering to prevent O(N) recalculation on every render
  ...
  // ⚡ Bolt: Memoize grouping to avoid O(N) recalculation on unrelated renders
  ...
  // ⚡ Bolt: Memoize key extraction and sort to prevent O(K log K) recalculation
...
// ⚡ Bolt: Memoize list items to prevent re-rendering all rows when the parent (Dashboard) updates
