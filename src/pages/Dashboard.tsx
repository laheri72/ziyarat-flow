...
export default function Dashboard() {
  ...
  // ⚡ Bolt: Hoisted searchQuery conversion and memoized filteredAssignments to prevent unnecessary re-filtering on every render
  ...
  // ⚡ Bolt: Memoized groupedAssignments to prevent unnecessary reducing on every render
  ...
  // ⚡ Bolt: Memoized groupedEventTags to prevent unnecessary sorting on every render
