...
export default function Dashboard() {
  ...
  const {
    ...
    const currentAssignments = currentEvent
    ...
    const canRequestMore = !!currentEvent && availableInMumbai && (total === 0 || isFullyCompleted);
    return {
      currentEventAssignments: currentAssignments,
      ...
      canRequestMoreForCurrentEvent: canRequestMore,
    };
  }, [assignments, currentEvent, availableInMumbai]);
