...
export default function Dashboard() {
  ...
  // ⚡ Bolt: Memoize assignment filtering to prevent O(N) recalculations on every keystroke
  // Expected impact: Faster search input responsiveness with large beneficiary lists
  ...
  // ⚡ Bolt: Memoize grouping map to avoid Object recreation on every render
  ...
  // ⚡ Bolt: Memoize sorting of groups to avoid Array.sort() on every render
