...
export default function Dashboard() {
  ...
  // ⚡ Bolt: Use useMemo for filtering and grouping, and pull the toLowerCase() conversion
  // out of the filter loop to prevent redundant string allocations per item.
