...
export default function Dashboard() {
  ...
  // ⚡ Bolt: Memoized expensive filtering and grouping operations to prevent unnecessary re-renders.
  // ⚡ Bolt: Hoisted searchQuery.toLowerCase() outside the filter loop to eliminate redundant synchronous string operations that block the main thread.
