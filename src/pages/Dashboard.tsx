...
export default function Dashboard() {
  ...
  // ⚡ Bolt: Memoize filtered assignments to prevent re-filtering on every render
  ...
  // ⚡ Bolt: Memoize grouped assignments to prevent re-grouping on every render
  ...
  // ⚡ Bolt: Memoize event tags sorting
...
// ⚡ Bolt: Memoize AssignmentRow to prevent re-rendering unchanged list items
