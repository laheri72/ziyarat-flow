...
export default function Dashboard() {
  ...
  // ⚡ Bolt: Memoized derived data to prevent recalculation on every render
...
// ⚡ Bolt: Wrapped in React.memo to prevent unnecessary re-renders when list data changes but this item doesn't
