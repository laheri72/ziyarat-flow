...
export default function Dashboard() {
  ...
  // ⚡ Bolt: Memoize filtered assignments to avoid re-calculating on every render,
  // especially when search query or assignments list hasn't changed.
  ...
  // ⚡ Bolt: Memoize grouped assignments to avoid re-reducing on every render.
  ...
  // ⚡ Bolt: Memoize sorted event tags to avoid re-sorting on every render.
