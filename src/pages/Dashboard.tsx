...
export default function Dashboard() {
  ...
  // ⚡ Bolt: Memoized expensive array operations (filtering and grouping assignments) to prevent unnecessary re-computations on every render.
  ...
  // ⚡ Bolt: Memoize the grouping of assignments based on the already memoized filteredAssignments.
  ...
  // ⚡ Bolt: Memoize the extraction and sorting of event tags based on groupedAssignments.
