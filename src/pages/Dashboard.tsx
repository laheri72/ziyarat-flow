...
export default function Dashboard() {
  ...
  // ⚡ Bolt: Memoize filtered and grouped assignments to prevent expensive recalculations on every render
  // ⚡ Bolt: Hoist searchQuery.toLowerCase() outside the filter loop to avoid redundant synchronous string operations
