...
export default function Dashboard() {
  ...
  // ⚡ Bolt: Memoize filtering to prevent recalculation on unrelated re-renders
  ...
  // ⚡ Bolt: Memoize grouping to prevent recalculation on unrelated re-renders
...
// ⚡ Bolt: Use React.memo for AssignmentRow to prevent unnecessary re-renders of the entire list when a single item changes
