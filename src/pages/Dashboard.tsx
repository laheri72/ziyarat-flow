...
export default function Dashboard() {
  ...
  // ⚡ Bolt: Memoize heavy data transformation (filtering) to avoid recalculating on unrelated state changes (like compactMode)
  ...
  // ⚡ Bolt: Memoize grouping to avoid O(n) operation on every render
  ...
  // ⚡ Bolt: Memoize sorting of event tags
...
// ⚡ Bolt: Wrap with memo to prevent re-renders unless specific props change
