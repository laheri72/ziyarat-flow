...
export default function Dashboard() {
  ...
  // ⚡ Bolt: memoize derived data to prevent recalculation on unrelated re-renders
  const { filteredAssignments, groupedAssignments, groupedEventTags } = React.useMemo(() => {
...
// ⚡ Bolt: wrap row component in React.memo to prevent unnecessary re-renders when parent state changes
