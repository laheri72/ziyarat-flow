...
export default function Dashboard() {
  ...
  // ⚡ Bolt: Memoize current event assignments to prevent recalculation on every render
  ...
  // ⚡ Bolt: Memoize filtered assignments to prevent re-filtering on un-related state changes (e.g., typing in other inputs, compact mode toggle)
  ...
  // ⚡ Bolt: Memoize grouped assignments to avoid re-reducing large arrays
