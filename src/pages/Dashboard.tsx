...
export default function Dashboard() {
  ...
  // ⚡ Bolt: Memoized derived states and hoisted searchQuery.toLowerCase() to prevent redundant synchronous string operations during filtering and unnecessary re-renders.
